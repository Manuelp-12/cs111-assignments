...
public class RURacing {
    ...
    public static void racer1(char[][] map) {
        ...
        int[] a = moveRacer(x1, y1, distance, map);
    
        System.out.println("Racer1 is at: (" + a[0] + "," + a[1] + ")");
    }
    ...
    public static void racer2(char[][] map) {
        ...
        while (mapdistance - (totaldistance + distance) >= 0) {
            a = moveRacer(x, y, distance, map);
            x = a[0];
            y = a[1];
